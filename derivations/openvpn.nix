# Patched openvpn to use with AWS vpn configs.
...
in
{
  ...
  openvpn_aws = generic {
    version = "2.5.1";
    sha256 = "sha256-QJMEicg3wF9hU/OOHrrsJEQx7xoDTkhG/3MtcdWf8ZQ=";
  };
}
